...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* Fraunces/Manrope/IBM Plex Mono/Caveat -- used by the marketing landing
        ...
        <link href="https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,400..600&family=Manrope:wght@400;500;600;700;800&family=IBM+Plex+Mono:wght@400;500&family=Caveat:wght@600;700&display=swap" rel="stylesheet" />
      </head>
