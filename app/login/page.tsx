...
export default function LoginPage() {
  return <main className="loginPage">
    <section className="loginBrand">
      ...
      <div><p className="eyebrow">CLIENT OUTREACH PORTAL</p><h1>Outreach that feels<br/>considered, not cold.</h1><p>Brief campaigns, share your lead lists, and follow every step from setup to replies.</p></div>
